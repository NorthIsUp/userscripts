...
// @noframes
// @updateURL    https://github.com/NorthIsUp/userscripts/releases/latest/download/okta-autofill-fastpass.user.js
// @downloadURL  https://github.com/NorthIsUp/userscripts/releases/latest/download/okta-autofill-fastpass.user.js
// ==/UserScript==
...
(function () {
    ...
    function setValue(el, value) {
        var _a;
        const setter = (_a = Object.getOwnPropertyDescriptor(Object.getPrototypeOf(el), 'value')) === null || _a === void 0 ? void 0 : _a.set;
        if (setter)
