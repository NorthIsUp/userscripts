...
(function () {
  ...
  // then stop unless this script's own @match covers the page.
  {
    ...
    if (!announce({"name":"Okta autofill + FastPass — teamclara","namespace":"https://github.com/NorthIsUp/userscripts/okta-autofill-fastpass","version":"2.1.6"}, "^https:\\/\\/github\\.com\\/NorthIsUp\\/userscripts\\/releases.*$", ["^https:\\/\\/teamclara\\.okta\\.com\\/.*$","^https:\\/\\/(?:[^/]+\\.)?okta\\.com\\/.*$"])) return;
  }
