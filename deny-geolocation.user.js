...
// @grant        GM_getValue
// @grant        GM_setValue
// @updateURL    https://github.com/NorthIsUp/userscripts/releases/latest/download/deny-geolocation.user.js
// @downloadURL  https://github.com/NorthIsUp/userscripts/releases/latest/download/deny-geolocation.user.js
// ==/UserScript==
...
(function () {
    ...
    const openConfig = () => {
        var _a;
        (_a = document.getElementById('deny-geo-cfg')) === null || _a === void 0 ? void 0 : _a.remove();
        const allows = store();
    ...
    if (!matchEntry(pruned)) {
        ...
        const notify = () => {
            ...
            if (document.body)
                ...
                addEventListener('DOMContentLoaded', show, { once: true });
        };
        const deny = (_ok, err) => {
            notify();
        ...
        try {
            ...
            if (perms === null || perms === void 0 ? void 0 : perms.query) {
                ...
                perms.query = ((desc) => (desc === null || desc === void 0 ? void 0 : desc.name) === 'geolocation'
