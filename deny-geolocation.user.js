...
(function () {
  ...
  // then stop unless this script's own @match covers the page.
  {
    ...
    if (!announce({"name":"Deny Geolocation","namespace":"https://github.com/NorthIsUp/userscripts/deny-geolocation","version":"0.2.6"}, "^https:\\/\\/github\\.com\\/NorthIsUp\\/userscripts\\/releases.*$", ["^https?:\\/\\/[^/]+\\/.*$"])) return;
  }
