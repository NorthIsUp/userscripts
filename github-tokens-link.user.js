...
// @grant        none
// @updateURL    https://github.com/NorthIsUp/userscripts/releases/latest/download/github-tokens-link.user.js
// @downloadURL  https://github.com/NorthIsUp/userscripts/releases/latest/download/github-tokens-link.user.js
// ==/UserScript==
...
(function () {
    ...
    function decorateMenu(menu) {
        ...
        if (!(settingsLi === null || settingsLi === void 0 ? void 0 : settingsLi.parentElement))
            return;
