...
(function () {
    ...
    function buildTokensItem(settingsLi) {
        ...
        li.querySelectorAll('[aria-labelledby]').forEach((el) =>
    ...
    function decorateMenu(menu) {
        ...
        if (
            settingsLi.parentElement.querySelector(`li[${ITEM_MARKER}]`)
        ) {
            return;
        }
    ...
    function scan(root) {
        ...
        const selector =
            'anchored-position, action-menu, [role="menu"], details-menu, ul';
