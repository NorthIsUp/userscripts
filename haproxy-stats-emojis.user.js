...
// @grant        none
// @updateURL    https://github.com/NorthIsUp/userscripts/releases/latest/download/haproxy-stats-emojis.user.js
// @downloadURL  https://github.com/NorthIsUp/userscripts/releases/latest/download/haproxy-stats-emojis.user.js
// ==/UserScript==
...
(function () {
    ...
    function updateAllSectionHeaders() {
        ...
        for (const link of headerLinks) {
            ...
            if (!th)
                continue;
            const anchorName = (_a = th.querySelector('a[name]')) === null || _a === void 0 ? void 0 : _a.getAttribute('name');
            if (!anchorName)
                continue;
