...
(function () {
  ...
  // then stop unless this script's own @match covers the page.
  {
    ...
    if (!announce({"name":"Code Helpers: GitHub PR list — Accepted PRs","namespace":"https://github.com/NorthIsUp/userscripts/github-pr-list-accepted","version":"1.1.2"}, "^https:\\/\\/github\\.com\\/NorthIsUp\\/userscripts\\/releases.*$", ["^https:\\/\\/github\\.com\\/.*\\/.*\\/pulls.*$"])) return;
  }
