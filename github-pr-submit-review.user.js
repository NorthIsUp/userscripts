...
// @namespace    https://github.com/NorthIsUp/userscripts/github-pr-submit-review
// @version      4.6.6
...
// @run-at       document-end
// @grant        none
// @updateURL    https://raw.githubusercontent.com/NorthIsUp/userscripts/dist/github-pr-submit-review.user.js
// @downloadURL  https://raw.githubusercontent.com/NorthIsUp/userscripts/dist/github-pr-submit-review.user.js
// ==/UserScript==
...
(function () {
    ...
    // then stop unless this script's own @match covers the page.
    {
      ...
      if (!announce({"name":"Code Helpers: GitHub PR — Submit Review Button","namespace":"https://github.com/NorthIsUp/userscripts/github-pr-submit-review","version":"4.6.6"}, "^https:\\/\\/github\\.com\\/NorthIsUp\\/userscripts\\/releases.*$", ["^https:\\/\\/github\\.com\\/.*\\/.*\\/pull\\/.*$"])) return;
    }
