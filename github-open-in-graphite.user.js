...
// @namespace    https://github.com/NorthIsUp/userscripts/github-open-in-graphite
// @version      1.8.6
...
// @run-at       document-end
// @grant        none
// @updateURL    https://raw.githubusercontent.com/NorthIsUp/userscripts/dist/github-open-in-graphite.user.js
// @downloadURL  https://raw.githubusercontent.com/NorthIsUp/userscripts/dist/github-open-in-graphite.user.js
// ==/UserScript==
...
(function () {
    ...
    // then stop unless this script's own @match covers the page.
    {
      ...
      if (!announce({"name":"Code Helpers: GitHub PR — Open in Graphite","namespace":"https://github.com/NorthIsUp/userscripts/github-open-in-graphite","version":"1.8.6"}, "^https:\\/\\/github\\.com\\/NorthIsUp\\/userscripts\\/releases.*$", ["^https:\\/\\/github\\.com\\/.*\\/.*\\/pull\\/.*$"])) return;
    }
